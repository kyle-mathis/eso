...
-- 10 = 3.4.11 - 3.4.14
-- 11 = 3.4.15
Harvest.addonVersion = 11
Harvest.displayVersion = "3.4.15"
...
Harvest.PINTYPES = {
	...
	Harvest.HEAVYSACK, Harvest.TROVE,
	Harvest.JUSTICE, Harvest.STASH,
	Harvest.TOUR
}
...
function Harvest.ShouldSaveItemId(pinTypeId)
	return (pinTypeId == Harvest.ALCHEMY)
end
...
local nodeName2PinType = {
	...
	["Épine-de-Dragon"] = Harvest.ALCHEMY,
