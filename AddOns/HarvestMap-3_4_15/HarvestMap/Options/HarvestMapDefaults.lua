...
Harvest.defaultSettings = {
	...
	mapLayouts = {
		...
		[Harvest.ALCHEMY]     = { level = 20, texture = "HarvestMap/Textures/Map/alchemy.dds", size = 20, tint = ZO_ColorDef:New(0.557, 1, 0.541, 1) },
	...
	compassLayouts = {
		...
		[Harvest.ALCHEMY]     = {texture = "HarvestMap/Textures/Compass/alchemy.dds", },
