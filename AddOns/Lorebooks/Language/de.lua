...
SafeAddString(LBOOKS_THANK_YOU3087,				"Herzlichen Glückwunsch", 1)
SafeAddString(LBOOKS_THANK_YOU_LONG3087,		"Es gibt niemanden wie dich", 1)
...
SafeAddString(LBOOKS_EIDETIC,						"Zeige bekannte Ewige Erinnerung", 1)
SafeAddString(LBOOKS_EIDETIC_DESC,				"Zeige/Verberge Schriften der Ewigen Erinnerung auf der Karte. Diese Schriften sind lore-bezogene Schriften, die nicht zur Reihe der Magiergilde gehören. Sie sind rein informativ über Tamriel.", 1)
SafeAddString(LBOOKS_EIDETIC_COLLECTED,		"Zeige unbekannte Ewige Erinnerung", 1)
SafeAddString(LBOOKS_EIDETIC_COLLECTED_DESC,	"Zeige/Verberge unbekannte Schriften auf der Karte, die nicht den Magiergilden-Skill steigern.", 1)
