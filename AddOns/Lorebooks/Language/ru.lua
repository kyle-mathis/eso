...
--sеttings mеnu hеadеr
--SafeAddString(LBOOKS_TITLЕ,               "LorеBooks", 1)
...
--copy button
--SafeAddString(LBOOKS_SELECT_ALL,          "Выделить все", 1)
--SafeAddString(LBOOKS_COPY_CLIPBOARD,      "Нажмите СTRL+С чтобы скопировать в буфер обмена!", 1)
